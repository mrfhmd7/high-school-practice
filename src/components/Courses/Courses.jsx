...
const Courses = () => {
     return (
          <>
               ...
               <div className='flex text-start mt-20 items-center'>
                    <img className='w-1/2' src="c-lady-1.png" alt="" />
                    <div>
                         <h2 className='font-bold text-5xl'>Video in Live Action</h2>
                         <p className='text-[#737373] text-lg font-semibold mt-5'>Problems trying to resolve the conflict between the two major realms of Classical physics:
                              <br />
                              Newtonian mechanics
                         </p>
                         <button className='text-[#96BB7C] border-[#96BB7C] mt-10 rounded-md border-2 pr-4 pt-3 pb-3 pl-4 font-bold'>Learn More</button>
